...
/* for ESCA kernel queue system call */
asmlinkage long sys_gemmini_inst_enqueue(u8, u8, u64, u64);	// xcustom, funct, rs1, rs2
asmlinkage long sys_gemmini_consumer_init(void);
asmlinkage long sys_gemmini_consumer_exit(void);
asmlinkage long sys_gemmini_fence(void);
asmlinkage long sys_init_model(u64, u64);
asmlinkage long sys_exit_model(u32);
asmlinkage long sys_nv_schedule(void);
asmlinkage long sys_nv_scheduler_init(int, int, int);
asmlinkage long sys_model_sleep_and_wait(u32, int);
